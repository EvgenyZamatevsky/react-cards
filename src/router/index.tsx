...
export const ROUTES = [
	...
	{ path: Path.CARDS_PARAM, element: <Cards /> },
	{ path: Path.LOGIN, element: <Login /> },
	{ path: Path.REGISTER, element: <Register /> },
	{ path: Path.FORGOT, element: <Forgot /> },
	{ path: Path.CHECK_EMAIL_PARAM, element: <CheckEmail /> },
	{ path: Path.NEW_PASSWORD_PARAM, element: <NewPassword /> },
	{ path: Path.LEARN_PARAM, element: <Learn /> },
